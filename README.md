...
- **Conversão em Tempo Real:** Conversão instantânea de valores utilizando taxas de câmbio atualizadas.
...
- `assets/css/`: Folhas de estilo organizadas por páginas e temas.
- `assets/javascript/`: Lógica dividida em módulos (Index, Gráfico, Modo Escuro).
- `assets/grafico.html`: Página dedicada à visualização gráfica das taxas.
